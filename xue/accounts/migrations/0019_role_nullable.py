...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DMUserProfile.role'
        db.alter_column('accounts_dmuserprofile', 'role', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'DMUserProfile.role'
        raise RuntimeError("Cannot reverse this migration. 'DMUserProfile.role' and its values cannot be restored.")
    ...
    models = {
        'accounts.dmuserprofile': {
            ...
            'role': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
