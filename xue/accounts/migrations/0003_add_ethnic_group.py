...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DMUserProfile.ethnic'
        db.add_column('accounts_dmuserprofile', 'ethnic', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
