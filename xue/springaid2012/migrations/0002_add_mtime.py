...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicationEntry.mtime'
        db.add_column('springaid2012_applicationentry', 'mtime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 3, 15), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicationEntry.mtime'
        db.delete_column('springaid2012_applicationentry', 'mtime')
