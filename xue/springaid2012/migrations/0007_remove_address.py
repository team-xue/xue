...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ApplicationEntry.home_addr'
        db.delete_column('springaid2012_applicationentry', 'home_addr')


    def backwards(self, orm):
        
        # Adding field 'ApplicationEntry.home_addr'
        db.add_column('springaid2012_applicationentry', 'home_addr', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255), keep_default=False)
