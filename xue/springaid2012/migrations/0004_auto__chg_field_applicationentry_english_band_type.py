...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApplicationEntry.english_band_type'
        db.alter_column('springaid2012_applicationentry', 'english_band_type', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'ApplicationEntry.english_band_type'
        db.alter_column('springaid2012_applicationentry', 'english_band_type', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'springaid2012.applicationentry': {
            ...
            'english_band_type': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
