...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('springaid2012_applicationentry', 'english_band_type', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'ApplicationEntry.english_band_score'
        raise RuntimeError("Cannot reverse this migration. 'ApplicationEntry.english_band_score' and its values cannot be restored.")
