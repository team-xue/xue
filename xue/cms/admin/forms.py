...
# text-based ModelMultipleChoiceField for easy tagging support
...
class PageForm(PageAddForm):
    ...
    # Tag support
    # TODO: I18N
    tags = TextModelMultipleChoiceField(Tag.objects.all(), label=u'Tags', required=False,
        help_text=u'Tags for the page, separated by commas (,)')
    # tags = forms.models.ModelMultipleChoiceField(Tag.objects.all(), label=u'Tags', required=False,
    #     help_text=u'Tags for the page, separated by commas (,)', widget=TextSelect)
