...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CentralStudentInfo.cylc_date'
        db.add_column('infocenter_centralstudentinfo', 'cylc_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'CentralStudentInfo.cpc_date'
        db.add_column('infocenter_centralstudentinfo', 'cpc_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CentralStudentInfo.cylc_date'
        db.delete_column('infocenter_centralstudentinfo', 'cylc_date')

        # Deleting field 'CentralStudentInfo.cpc_date'
        db.delete_column('infocenter_centralstudentinfo', 'cpc_date')
    ...
    models = {
        ...
        'infocenter.centralstudentinfo': {
            ...
            'cpc_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'cylc_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
