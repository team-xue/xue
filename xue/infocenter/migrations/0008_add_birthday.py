...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CentralStudentInfo.birthday'
        db.add_column('infocenter_centralstudentinfo', 'birthday', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CentralStudentInfo.birthday'
        db.delete_column('infocenter_centralstudentinfo', 'birthday')
