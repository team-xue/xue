...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Target.template'
        db.add_column('uniapply_target', 'template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['impexp.ExportTemplate'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Target.template'
        db.delete_column('uniapply_target', 'template_id')
    ...
    models = {
        ...
        'uniapply.target': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['impexp.ExportTemplate']", 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
