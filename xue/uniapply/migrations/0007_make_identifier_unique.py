...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Target', fields ['identifier']
        db.create_unique('uniapply_target', ['identifier'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Target', fields ['identifier']
        db.delete_unique('uniapply_target', ['identifier'])
