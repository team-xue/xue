...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UniApplicationEntry.ctime'
        db.add_column('uniapply_uniapplicationentry', 'ctime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 9, 3, 2, 26, 39, 895000), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UniApplicationEntry.ctime'
        db.delete_column('uniapply_uniapplicationentry', 'ctime')
