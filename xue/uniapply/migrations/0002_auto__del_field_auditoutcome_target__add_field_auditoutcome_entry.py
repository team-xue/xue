...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AuditOutcome.target'
        db.delete_column('uniapply_auditoutcome', 'target_id')

        # Adding field 'AuditOutcome.entry'
        db.add_column('uniapply_auditoutcome', 'entry', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['uniapply.UniApplicationEntry']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AuditOutcome.target'
        raise RuntimeError("Cannot reverse this migration. 'AuditOutcome.target' and its values cannot be restored.")

        # Deleting field 'AuditOutcome.entry'
        db.delete_column('uniapply_auditoutcome', 'entry_id')
