...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Target.template'
        db.alter_column('uniapply_target', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['impexp.ExportTemplate']))


    def backwards(self, orm):
        
        # Changing field 'Target.template'
        db.alter_column('uniapply_target', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['impexp.ExportTemplate'], null=True))
    ...
    models = {
        ...
        'uniapply.target': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['impexp.ExportTemplate']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
