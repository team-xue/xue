...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Target.allow_blank_reason'
        db.delete_column('uniapply_target', 'allow_blank_reason')


    def backwards(self, orm):
        
        # Adding field 'Target.allow_blank_reason'
        db.add_column('uniapply_target', 'allow_blank_reason', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
