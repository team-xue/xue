...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Target.identifier'
        db.add_column('uniapply_target', 'identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Target.identifier'
        db.delete_column('uniapply_target', 'identifier')
